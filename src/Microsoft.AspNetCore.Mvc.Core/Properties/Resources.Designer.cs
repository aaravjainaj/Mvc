...
namespace Microsoft.AspNetCore.Mvc.Core
{
    ...
    internal static class Resources
    {
        ...
        /// <summary>
        /// While processing template '{0}', a replacement value for the token '{1}' could not be found. Available tokens: '{2}'. To use a '[' or a ']' as a literal string in a route or within a constraint use '[[' or ']]' instead.
        /// </summary>
