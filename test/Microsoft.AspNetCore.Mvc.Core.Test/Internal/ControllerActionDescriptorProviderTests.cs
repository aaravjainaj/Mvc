    ...
    public class ControllerActionDescriptorProviderTests
    {
        ...
        public void AttributeRouting_TokenReplacement_ThrowsWithMultipleMessages()
        {
            ...
            var expectedMessage =
                ...
                "could not be found. Available tokens: 'action, controller'. To use a '[' or a ']' as a literal string in" +
        ...
        public void AttributeRouting_RouteNameTokenReplace_InvalidToken()
        {
            ...
            var expectedMessage =
                ...
                "could not be found. Available tokens: 'action, controller'. To use a '[' or a ']' as a literal string" +
